...
document.querySelector('.btn-hold').addEventListener('click', function() {
    if (gamePlaying) {
        // we add current score to global score (****)
        ...
        // we make an option to change the winning score
        var input = document.querySelector('.final-score').value; //'.value' lets user to select value (****)
        var winningScore;   //we need this variable in order to select what the winningScore will be -- either (a) user's value or (b) pre-set 50
